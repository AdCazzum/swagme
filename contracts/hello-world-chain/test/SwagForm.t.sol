...
contract SwagFormTest is Test {
    ...
    function testOnlyCreatorCanModifyForm() public {
        ...
        (string memory title, string memory description, , bool isActive, , , ) = swagForm.getForm(0);
    ...
    function testAnyoneCanSubmitToActiveForm() public {
        ...
        SwagForm.Submission memory submission2 = swagForm.getSubmission(0, user2);
        SwagForm.Submission memory submission3 = swagForm.getSubmission(0, user3);
    ...
    function testOnlyCreatorCanViewAllSubmissions() public {
        ...
        vm.prank(user1);
        SwagForm.Submission[] memory allSubmissions = swagForm.getAllFormSubmissions(0);
    ...
    function testGetUserStats() public {
        ...
        (uint256 formsCreated1, uint256 formsSubmitted1) = swagForm.getUserStats(user1);
        assertEq(formsCreated1, 2);
        assertEq(formsSubmitted1, 0);
        
        // Verifica statistiche user2
        (uint256 formsCreated2, uint256 formsSubmitted2) = swagForm.getUserStats(user2);
        assertEq(formsCreated2, 1);
        assertEq(formsSubmitted2, 2);
        
        // Verifica statistiche user3
        (uint256 formsCreated3, uint256 formsSubmitted3) = swagForm.getUserStats(user3);
    ...
    function testCannotSubmitTwiceFromSameAddress() public {
        ...
        swagForm.submitForm(0, "user2_updated", "user2_updated@example.com", answers);
    }
